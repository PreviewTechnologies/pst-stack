...
abstract class AuthorQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'travel', $modelName = '\\Author', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = AuthorTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
