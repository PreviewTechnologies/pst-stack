...
abstract class PublisherQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'travel', $modelName = '\\Publisher', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = PublisherTableMap::getInstanceFromPool(null === $key || is_scalar($key) || is_callable([$key, '__toString']) ? (string) $key : $key))) && !$this->formatter) {
